...
export interface SessionData {
  isAdmin: boolean;
  // Email exists for compatibility with the existing AdminDashboard prop;
  // for a single-admin homelab this is hard-coded once authenticated.
  email?: string;
}
...
/**
 * Verifies the supplied password against ADMIN_PASSWORD env var.
 * On success, marks the session as authenticated.
 */
