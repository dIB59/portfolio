...
import { ArrowLeft, LogOut, FolderKanban, Code2, RefreshCw } from "lucide-react"
...
export function AdminDashboard({ userEmail }: AdminDashboardProps) {
  const [activeTab, setActiveTab] = useState<"projects" | "updates" | "leetcode">("projects")
      ...
      <div className="relative z-10 py-12 px-4">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">Manage your projects and LeetCode journey</p>
          </motion.div>
