...
import type { LeetCodeProblem, Confidence } from "@/lib/leetcode-types"
					...
					<div className="flex-1">
						...
						{problem.stuckOn && (
							<div className="mb-3">
								...
								<p className="text-sm text-foreground/80 mt-1">{problem.stuckOn}</p>
							</div>
						)}
						...
						{problem.notes && (
							<div>
								...
								<p className="text-sm text-foreground/80 mt-1">{problem.notes}</p>
							</div>
						)}
					</div>
				</div>
