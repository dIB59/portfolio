  ...
  return (
    <group position={position}>
      ...
      <mesh position={[0, 3, 1.3]} castShadow>
        ...
        <meshStandardMaterial color="#8b6914" flatShading rotation={[Math.PI / 2, 0, 0]} />
      </mesh>
      {/* Blades */}
      {[0, 1, 2, 3].map((i) => (
        <mesh key={i} position={[0, 3, 1.5]} rotation={[0, 0, (Math.PI / 2) * i]} castShadow>
  ...
  return (
    <group>
      ...
      <mesh position={[0, wallHeight / 2, -areaSize]} castShadow>
        <boxGeometry args={[areaSize * 2 + wallThickness, wallHeight, wallThickness]} />
      ...
      <mesh position={[areaSize, wallHeight / 2, 0]} castShadow>
        <boxGeometry args={[wallThickness, wallHeight, areaSize * 2 + wallThickness]} />
        <meshStandardMaterial color="#d4b896" flatShading />
      </mesh>
      {/* West wall */}
      <mesh position={[-areaSize, wallHeight / 2, 0]} castShadow>
...
export function Village() {
  const houses = useMemo(
    () => [
      { position: [-20, 0, -15] as [number, number, number], rotation: 0.3, color: "#f8c4b4", roofColor: "#c9a87c" },
      { position: [-25, 0, -8] as [number, number, number], rotation: -0.2, color: "#ffe4c4", roofColor: "#a67c52" },
      { position: [20, 0, -12] as [number, number, number], rotation: 0.5, color: "#ffd8c4", roofColor: "#c9a87c" },
      { position: [25, 0, 8] as [number, number, number], rotation: -0.4, color: "#f8d4b4", roofColor: "#b8956c" },
      { position: [-18, 0, 18] as [number, number, number], rotation: 0.8, color: "#ffe8d4", roofColor: "#c9a87c" },
      { position: [15, 0, 20] as [number, number, number], rotation: -0.6, color: "#f8c8b8", roofColor: "#a67c52" },
      {
